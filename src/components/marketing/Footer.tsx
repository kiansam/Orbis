  ...
  return (
    ...
    >
      <div className="footer-container">
        ...
        >
          <p style={{ fontSize: "12px", color: "var(--color-text-faint)" }}>
            © 2026 Orbis Solutions. All rights reserved.
          </p>
        </div>
      </div>
      ...
      <style>{`
        ...
        .footer-grid { display: grid; grid-template-columns: 2fr 1fr 1fr; gap: 48px; margin-bottom: 0; }
        .footer-col-heading { font-size: 12px; font-weight: 600; color: var(--color-text-primary); text-transform: uppercase; letter-spacing: 0.06em; margin-bottom: 16px; margin-top: 0; }
        .footer-link { font-size: 14px; color: var(--color-text-muted); text-decoration: none; transition: color 150ms ease; display: block; }
