      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 48px' }}>
        ...
        >
          <motion.h2
            ...
            style={{ fontSize: 'clamp(32px, 4vw, 48px)', fontWeight: 700, color: 'var(--color-text-primary)', letterSpacing: '-0.025em', lineHeight: 1.1, marginBottom: '20px' }}
          >
            Ready to stop missing jobs after hours?
          </motion.h2>
          <motion.p
            variants={childVariants}
            style={{ fontSize: '18px', color: 'var(--color-text-muted)', maxWidth: '520px', margin: '0 auto 40px', lineHeight: 1.6 }}
          >
          ...
          <motion.p
            variants={childVariants}
            style={{ fontSize: '13px', color: 'var(--color-text-faint)', marginTop: '24px' }}
          >
