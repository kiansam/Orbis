  ...
  return (
    <div className="bg-background-card border border-border rounded-2xl p-8 shadow-2xl">
      <div className="text-center mb-8">
        ...
        <p className="text-foreground-muted text-sm">Sign in to your Orbis Solutions account</p>
      </div>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <span className="text-foreground-muted text-xs">or continue with email</span>
        <Separator className="bg-border flex-1" />
      </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="flex items-center justify-center h-64"><div className="w-8 h-8 border-2 border-accent/30 border-t-accent rounded-full animate-spin" /></div>}>
      <LoginContent />
    </Suspense>
  )
}
